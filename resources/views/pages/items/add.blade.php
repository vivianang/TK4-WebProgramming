    ...
    <div class="card-body">
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ old('type') }}" class="form-control @error('type') is-invalid @enderror" name="type">
            ...
            <div class="form-group">
                ...
                <input type="number" value="{{ old('buying_price') }}" class="form-control @error('buying_price') is-invalid @enderror" name="buying_price">
